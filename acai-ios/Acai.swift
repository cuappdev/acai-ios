...
class Acai {
    ...
    static let testBowl = MenuItem(title: "Test Bowl", price: 8.99, optionsArrayObject: OrderCustomizationOptionsArray(optionsArray: [
        OrderCustomizationOptions(options: [
            ...
            OrderCustomizationOption(title: "Yogurt", isSelected: true, price: 6.99, type: .base, image: UIImage(named: "acaiBowl")!)], type: .base),
        OrderCustomizationOptions(options: [
            ...
            ], type: .topping)]), image: UIImage(named: "acaiBowl")!, type: .bowl)
    
    static let testSmoothie = MenuItem(title: "Test Smoothie", price: 8.99, optionsArrayObject: OrderCustomizationOptionsArray(optionsArray: [
        OrderCustomizationOptions(options: [
            ...
            OrderCustomizationOption(title: "Large", isSelected: true, price: 8.99, type: .size, image: UIImage(named: "acaiBowl")!)], type: .size),
        OrderCustomizationOptions(options: [
            OrderCustomizationOption(title: "Strawberry", isSelected: true, price: 1.00, type: .topping),
            OrderCustomizationOption(title: "Pineapple", isSelected: false, price: 1.00, type: .topping),
            OrderCustomizationOption(title: "Granola", isSelected: false, price: 1.00, type: .topping),
            ...
            OrderCustomizationOption(title: "Almonds", isSelected: false, price: 1.00, type: .topping),
            OrderCustomizationOption(title: "Peanut Butter", isSelected: false, price: 1.00, type: .topping)
            ], type: .topping)]), image: UIImage(named: "acaiBowl")!, type: .smoothie)
